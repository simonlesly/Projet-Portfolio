...
characters = {
    ...
    #Homme et démon
    "Muzan": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":False, "cheveux_noir": True,"adulte":True,"chef":True},
    "Gyotaro": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":False, "cheveux_noir": False,"adulte":True,"famille":True},
    "Kokushibo": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":True, "cheveux_noir": True,"famille":True},
    "Hantegu": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":True, "cheveux_noir": True,"adulte":True},
    "Kaigaku": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":True, "cheveux_noir": True,"adulte":False},
    "Akaza": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":True, "cheveux_noir": False,"adulte":True,"arc_en_ciel":False,"poisson":False},
    "Gyokko": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":True, "cheveux_noir": False,"adulte":True,"arc_en_ciel":False,"poisson":True},
    "Doma": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":True, "cheveux_noir": False,"adulte":True,"arc-en-ciel":True},
    "Yushiro": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":False, "cheveux_noir": False,"adulte":True,"famille":False},
    "Rui": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":False, "cheveux_noir": False,"araignée":True},
    "Enmu": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":False, "cheveux_noir": True,"adulte":True},
    "Yahaba": {"homme": True,"humain":  False, "pouvoirs": True, "pillier": False, "supérieur":False, "cheveux_noir": True,"adulte":False},
